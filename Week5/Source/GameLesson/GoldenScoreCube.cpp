...
AGoldenScoreCube::AGoldenScoreCube()
{
    ...
    // 加载金色材质
    static ConstructorHelpers::FObjectFinder<UMaterialInterface> GoldenMaterialFinder(TEXT("Material'/Game/Material/M_GoldenMaterial.M_GoldenMaterial'"));
